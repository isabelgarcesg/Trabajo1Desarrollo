...
function Register({ onSave }) {
  ...
  return (
    ...
    <div>
      <h1 className="font-bold px-6 text-lg mb-4 ml-10">Crear registro</h1>
    </div>
  ...
  <form onSubmit={handleSubmit(save)}>
    <div className="-mx-3 md:flex mb-4">
      <div className="md:w-1/2 px-3 md:mb-0">
        <label className="block text-sm font-bold mb-2" htmlFor="Especialidad">
          Especialidad
        </label>
        <input
          ...
          onChange={(event) => setEspe(event.target.value)}
          value={especialidad}
        />
      ...
      <label className="block text-sm font-bold mb-2" htmlFor="paraclinicos">
        Paraclinicos
      </label>
      <textarea
        className="appearance-none block w-full bg-gray-lighter text-gray-darker border border-red rounded py-3 px-4 mb-3"
        id="paracli"
        type="text"
      ...
      <label className="block text-sm font-bold mb-2" htmlFor="Evolucion">
        Evolucion
      </label>
      <input
        className="appearance-none block w-full bg-gray-lighter text-gray-darker border border-gray-lighter rounded py-3 px-4"
        ...
        onChange={(event) => setEvo(event.target.value)}
        value={evolucion}
      />
    ...
    <div className="-mx-3 md:flex mb-2 mt-4">
      <div className="md:w-1/2 px-3">
        <label className="block text-sm font-bold mb-2" htmlFor="Medicamento">
          Medicamento
        </label>
        <div className="relative">
          <select
            className="block appearance-none w-full bg-gray-lighter border border-gray-lighter text-gray-darker py-3 px-4 pr-8 rounded"
            id="Medicamento"
      ...
      <div className="md:w-1/2 px-3">
        <label className="block text-sm font-bold mb-2" htmlFor="Procedimientos">
          Procedimientos
        </label>
        <div className="relative">
          <select
    ...
    <button
      disabled={!especialidad || !paraclinicos || !evolucion || !medicamentoId || !nombreMedicamento || !dosis || !via || !frecuencia_dia || !duracion_dias || !observaciones || !procedimientoId || !nombrePro || !descripcion}
      className="bg-sky-300 py-2 px-4 rounded-full mt-10 "
